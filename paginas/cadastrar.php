		...
		<div class="container chamada-banner introducao">
			<div class="row">
				<div class="row-md-12 text-center ">
					...
					<main class="container  mt-4 p-3 formulario-usuario">
						...
						<form class="mt-2" action="../backEnd/InteracaoFront/cadastrar.php" method="POST">
							...
							<div class="mb-1 text-start">
								...
								<input type="email" name="email" class="form-control container input-group-text" required>
							</div>
							...
							<div class="mb-1 text-start">
								...
								<input type="password" name="confirmarSenha" class="form-control text-center" required>
							</div>
