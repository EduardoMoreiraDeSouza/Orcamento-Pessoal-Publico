<footer class="bg-dark text-light">
    <div class="container-fluid py-3 text-center">
        <ul class="list-group">
            <li class="list-group-link">
                ...
                <a href="https://github.com/EduardoMoreiraDeSouza" target="_blank"
    ...
    <div class="text-center" style="background-color: #333; padding: 10px;">
        <a href="https://www.eddumoreira.com" target="_blank" style="text-decoration: none">By Eduardo Moreira<a>
    </div>
</footer>
<script>
    ...
    function setMinHeight() {
        ...
        let alturaSection = document.querySelector('div.introducao').clientHeight;
        let alturaTabela = document.querySelector('body').clientHeight;
